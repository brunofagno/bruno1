...
sexo %>% ggplot(aes(x = Período, y = Percentual, fill = Sexo)) +
  ...
  theme_ipsum() + 
  ggtitle("Percentual de casos de SRAG por sexo")
...
idade %>% ggplot(aes(x = Período, y = Percentual, fill = Idade)) +
  geom_col(position = "dodge") +
  theme_ipsum() + 
  ggtitle("Percentual de casos de SRAG por idade")
```
...
evolucao %>% ggplot(aes(x = Período, y = Percentual, fill = Evolução)) +
  geom_col(position = "dodge") +
  theme_ipsum() + 
  ggtitle("Percentual de casos de SRAG por evolução")
...
amostra %>% ggplot(aes(x = Período, y = Percentual, fill = Amostra)) +
  geom_col(position = "dodge") +
  theme_ipsum() + 
  ggtitle("Percentual de casos de SRAG por amostra")
